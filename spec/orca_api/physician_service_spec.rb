...
RSpec.describe OrcaApi::PhysicianService, orca_api_mock: true do
  ...
  describe "#list" do
    let(:response_json) { load_orca_api_response_json("api01rv2_system01lstv2_02.json") }
    ...
    shared_examples "結果が正しいこと" do
      ...
      its(:physician_information) { is_expected.to eq(response_json.first[1]["Physician_Information"]) }
    end
